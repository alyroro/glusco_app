  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        Here’s what we found based on your data this week
      </Text>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.description}>
          Keep tracking your daily habits to improve your diet, activity, and
          sleep for better health.
        </Text>

        {/* Button */}
        <TouchableOpacity style={styles.button} onPress={onNext}>
          <Text style={styles.buttonText}>View Explanation</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
