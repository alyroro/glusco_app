...
export default function Onboarding3() {
  ...
  return (
    <View style={styles.container}>
      <Image
        source={require("../../assets/images/thesis-illus/onboarding3.png")}
        style={styles.image}
      />

      <View style={styles.textContainer}>
        <Text style={styles.title}>Connect, Learn, and Share</Text>
        <Text style={styles.description}>
          Join discussions with others on the same journey. Share tips, ask
          questions, and get inspired to live healthier together.
        </Text>
